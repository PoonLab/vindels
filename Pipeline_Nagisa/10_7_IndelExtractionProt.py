...
files = glob("/home/jpalme56/PycharmProjects/hiv-evolution-master/10_6_Pairwise_Prot/*.fastaz")
...
for x in files:
    ...
    output1 = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/10_7_NGlycs_total/" + filename +"_t.fasta", "w")
    output2 = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/10_8_NGlycs_i/" + filename + "_i.fasta", 'w')
...
#This code finds all the unique glyc sites found in the reference (1) and query (2) sequences
#unique1 = ngSet1 - ngSet2
#unique2 = ngSet2 - ngSet1
#print("unique")
#print(unique1)
#print(unique2)
#Interfered contains all the N-glyc sites that have:
    #1) Overlapped with an insertion sequence (based on overlap dictionary) AND
    #2) Are only found within a single sequence within their cherry pair
#interfered[header] = tuple((list(unique1.intersection(overlapSet1)), list(unique2.intersection(overlapSet2))))
