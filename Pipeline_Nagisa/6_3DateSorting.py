...
# DICTIONARY (gbdates):  [accession #s] = accurate dates
for line in input:
    info = line.strip("\n\r").split(".")
...
# DICTIONARY (subtypes):  [subtype] =  accession #s
...
for x in subtypes:
    print(x)
    temp = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/Dates/temp.txt", 'w')
    ...
    temp.close()
    infile = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/Dates/temp.txt", 'r')

    output = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/Dates/" + x +".csv", 'w')
...
os.remove("/home/jpalme56/PycharmProjects/hiv-evolution-master/Dates/temp.txt")