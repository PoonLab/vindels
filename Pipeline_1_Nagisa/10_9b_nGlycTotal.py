...
folder = glob("/home/jpalme56/PycharmProjects/hiv-evolution-master/3RegionSequences/VRegions_edit/*.csv")

output = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/ngTotal.csv", 'w')
