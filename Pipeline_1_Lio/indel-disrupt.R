...
plot(x=ngProps.df$prop, y=disrupt$prop,  las=1,pch=(disrupt$vloop+20),bg=colors,cex=3, cex.axis=1.85,main=NULL, xlab="",ylab="",xlim=lim,ylim=lim) 
par(xpd=NA)
legend(0.85,0.5,legend=c('V1 ','V2 ','V3 ','V4 ','V5'), pch=c(21,22,23,24,25), cex=2, pt.bg=colors,x.intersp = 1.2,y.intersp=1.1, pt.cex=3.5)
par(xpd=F)
#abline(0,1)
title(ylab="Proportion of Indels affecting PNGS", line=5.5, cex.lab=2.2)
title(xlab="Proportion of PNGS Content", line=4.5, cex.lab=2.2)
