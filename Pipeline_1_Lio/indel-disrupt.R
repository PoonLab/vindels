...
par(xpd=NA)
legend(0.6,0.3,legend=c('V1 ','V2 ','V3 ','V4 ','V5'), pch=c(21,22,23,24,25), cex=1.5, pt.bg=colors,x.intersp = 1.3,y.intersp=1.2, pt.cex=2.9)
par(xpd=F)
#abline(0,1)
title(ylab="Proportion of Indels Affecting PNGS", line=4.5, cex.lab=1.8)
title(xlab="V-Loop PNGS Content", line=4.5, cex.lab=1.8)
