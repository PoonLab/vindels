...
plot(x=ngProps.df$prop, y=disrupt$prop,  las=1,pch=(disrupt$vloop+20),bg=colors,cex=2.8, cex.axis=1.5,main=NULL, xlab="",ylab="",xlim=lim,ylim=lim) 
legend(0.60,0.28,legend=c('V1 ','V2 ','V3 ','V4 ','V5'), pch=c(21,22,23,24,25), cex=1.6, pt.bg=colors,x.intersp = 1.5,y.intersp=1, pt.cex=2.4)
#abline(0,1)
title(ylab="Indels disrupting PNGS / Total Indels", line=5, cex.lab=1.7)
title(xlab="PNGS Amino Acids / Total Amino Acids", line=4, cex.lab=1.7)
