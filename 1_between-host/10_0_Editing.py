...
files = glob("/home/jpalmer/PycharmProjects/hiv-evolution-master/10_Cherries/*+.csv")
...
for x in files:
    ...
    output = open("/home/jpalmer/PycharmProjects/hiv-evolution-master/10_Cherries/" + subtype + "+.fasta", 'w')
