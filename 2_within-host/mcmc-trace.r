...
tru <- c(0.00016, 0.75, 0.00001, 0.15)
...
par(mar=c(2.5,5,3,1), mfrow=c(5,1))
plot(csv[-(1:burnin)
         ,'p.enter'], type = "l", xlab="MCMC Steps (x10)" , ylab="Prob(Enter)",
     main = "Chain values of Enter", cex.axis=1.3, cex.lab=1.4, cex.main=1.7, ylim=c(0.00008, 0.00018))
abline(h=tru[1],col='red',lwd=2)
plot(csv[-(1:burnin)
         ,'p.stay'], type = "l", xlab="MCMC Steps (x10)" , ylab="P(Stay)",
     main = "Chain values of Stay",  cex.axis=1.3, cex.lab=1.4, cex.main=1.7, ylim=c(0.62, 0.77))
abline(h=tru[2],col='red',lwd=2)
plot(csv[-(1:burnin)
         ,'rate'], type = "l", xlab="MCMC Steps (x10)" , ylab="Rate",
...
plot(csv[-(1:burnin)
     ...
     main = "Chain values of Fix",  cex.axis=1.3, cex.lab=1.4, cex.main=1.7)#, ylim=c(0.0001,0.00015))
