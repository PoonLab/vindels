...
xmlFolder = glob("/home/jpalmer/PycharmProjects/hiv-withinhost/5BEAST/e4-lognorm/*.xml")
...
for infile in xmlFolder:
    ...
    xml.write("/home/jpalmer/PycharmProjects/hiv-withinhost/5_1_BEASTguided/e4-lognorm/"+xmlname)
