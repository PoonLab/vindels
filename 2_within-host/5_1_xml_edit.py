...
xmlFolder = glob("/home/jpalmer/PycharmProjects/hiv-withinhost/5BEAST/pop5-skygrid-lognorm-p10/*.xml")
...
for infile in xmlFolder:
    ...
    xml.write("/home/jpalmer/PycharmProjects/hiv-withinhost/5_1_BEASTguided/pop5-skygrid-lognorm-p10/"+xmlname)
