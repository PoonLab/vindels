...
parameters {
  real<lower=0.00001, upper=5> sub_rate;
  real<lower=0.00001, upper=5> sub_sd;
  real<lower=0.00001, upper=5> pat_rates[npat];
  real<lower=0.00001,upper=5> pat_sd;
  real<lower=0.00001, upper=5> tre_rates[ntree];
}
