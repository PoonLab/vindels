...
write.table(ins[,-c(3,4,5)],paste0(path, "13_nglycs/ins-sep.csv"), row.names=F, sep="\t", quote=F)
write.table(del[,-c(3,4,5)],paste0(path, "13_nglycs/del-sep.csv"), row.names=F, sep="\t", quote=F)
