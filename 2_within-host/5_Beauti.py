...
template_file = '/home/jpalmer/vindels/2_within-host/template-skygrid.xml'
...
for f in files:
    ...
    for rep in ['a','b']:
        ...
        print(name)
        xmlpath = '/home/jpalmer/PycharmProjects/hiv-withinhost/5BEAST/hm-skygrid/'
        out = xmlpath + name + ".xml"
        #os.mkdir(xmlpath+name+'/')
        #stem = xmlpath+name+"/"

        #override stem to test output location
        stem = '/home/jpalmer/16BEAST-skygrid/output/' + name
        print(stem)
        print(out)
