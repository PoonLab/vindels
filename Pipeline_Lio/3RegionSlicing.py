...
alignments = glob('/home/jpalme56/PycharmProjects/hiv-evolution-master/2_1_AAPairwise/*++.fasta')
...
for file in alignments:
    ...
    outputv = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/3RegionSequences/VRegions_mod/"+ filename + "_VR.csv", "w")
    outputc = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/4_2_Conserved/" + filename + "_CR.fasta", "w")
