...
files = glob("/home/jpalmer/PycharmProjects/hiv-evolution-master/10_1_Pairwise_Nt/*++.fastaz")
...
seqOrder = []
ntOutput = open("/home/jpalmer/PycharmProjects/hiv-evolution-master/noindel.csv",'w')
ntOutput.write("filename,A.1,A.2,A.3,A.4,A.5,C.1,C.2,C.3,C.4,C.5,G.1,G.2,G.3,G.4,G.5,T.1,T.2,T.3,T.4,T.5\n")
ntOutput2 = open("/home/jpalmer/PycharmProjects/hiv-evolution-master/indel.csv",'w')
...
for x in sorted(files):
    ...
    output = open("/home/jpalmer/PycharmProjects/hiv-evolution-master/10_2_NtIndels/" + filename, "w")
