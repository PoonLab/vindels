...
files = glob("/home/jpalme56/PycharmProjects/hiv-evolution-master/10_5_Translated_Cherries/*+.fasta")
...
for n in files:
    ...
    subtype = n.split("/")[-1]
    output = open("/home/jpalme56/PycharmProjects/hiv-evolution-master/10_6_Pairwise_Prot/" +subtype + "z", 'w')
